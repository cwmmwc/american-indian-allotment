-- cancelled_patent_research: research data on fee patents that were later
-- cancelled. Source: Cancelled patents_6.11._cwm.xlsx, compiled by
-- Christian McMillen from primary BIA records, documenting the legal
-- authority and circumstances of each cancellation. Complements the BLM
-- cancelled_doc flag in all_patents, which knows that cancellation
-- happened but carries no reason information for ~86% of cancelled patents.
